...
func TestIntegration_ChannelAddTelegram(t *testing.T) {
	...
	out, err := claws(t, root, "channel", "add", "alpha", "telegram", "--token=123:faketoken")
	if err != nil {
	...
	if !strings.Contains(out, "claws approve") {
...
func TestIntegration_ChannelAddDiscord(t *testing.T) {
	...
	out, err := claws(t, root, "channel", "add", "alpha", "discord", "--token=faketoken")
	if err != nil {
		t.Fatalf("channel add failed: %v\n%s", err, out)
	}
...
func TestIntegration_ChannelAddSlack(t *testing.T) {
	...
	out, err := claws(t, root, "channel", "add", "alpha", "slack", "--bot-token=xoxb-fake", "--app-token=xapp-fake")
	if err != nil {
		t.Fatalf("channel add failed: %v\n%s", err, out)
	}
...
func TestIntegration_ChannelAddMissingToken(t *testing.T) {
	...
	_, err := claws(t, root, "channel", "add", "alpha", "telegram")
	if err == nil {
...
func TestIntegration_ChannelAddCustomDmPolicy(t *testing.T) {
	...
	claws(t, root, "channel", "add", "alpha", "telegram", "--token=123:fake", "--dm-policy=allowlist")
...
func TestIntegration_ChannelStatus(t *testing.T) {
	root := t.TempDir()
	claws(t, root, "create", "alpha")
	claws(t, root, "channel", "add", "alpha", "telegram", "--token=123:fake")

	out, err := claws(t, root, "channel", "status", "alpha")
	if err != nil {
...
func TestIntegration_ChannelRemove(t *testing.T) {
	...
	claws(t, root, "create", "alpha")
	claws(t, root, "channel", "add", "alpha", "telegram", "--token=123:fake")
	claws(t, root, "channel", "remove", "alpha", "telegram")
...
func TestIntegration_ChannelHelp(t *testing.T) {
	root := t.TempDir()
	out, _ := claws(t, root, "channel", "--help")
...
func TestIntegration_ApproveHelp(t *testing.T) {
	root := t.TempDir()
	out, _ := claws(t, root, "approve", "--help")
...
func TestIntegration_ChannelAddAllowSend(t *testing.T) {
	root := t.TempDir()
	claws(t, root, "create", "alpha")
	claws(t, root, "channel", "add", "alpha", "telegram", "--token=123:fake", "--allow-send")
...
func TestIntegration_ChannelAddDiscordSafeDefaults(t *testing.T) {
	root := t.TempDir()
	claws(t, root, "create", "alpha")
	claws(t, root, "channel", "add", "alpha", "discord", "--token=fake")
...
func TestIntegration_ChannelSecurity(t *testing.T) {
	...
	out, err := claws(t, root, "channel", "security", "alpha")
	if err != nil {
...
func TestIntegration_ChannelSend(t *testing.T) {
	...
	// Enable
	out, err := claws(t, root, "channel", "send", "alpha", "telegram", "--enable")
	if err != nil {
	...
	// Disable
	claws(t, root, "channel", "send", "alpha", "telegram", "--disable")
	cfg = readJSON(t, filepath.Join(root, "alpha", "openclaw.json"))
	actions = cfg["channels"].(map[string]any)["telegram"].(map[string]any)["actions"].(map[string]any)
	if actions["sendMessage"] != false {
...
func TestIntegration_ChannelAllowDeny(t *testing.T) {
	...
	// Allow
	out, err := claws(t, root, "channel", "allow", "alpha", "telegram", "+1234567890")
	if err != nil {
	...
	claws(t, root, "channel", "allow", "alpha", "telegram", "+9876543210", "+1234567890")
	cfg = readJSON(t, filepath.Join(root, "alpha", "openclaw.json"))
	tg = cfg["channels"].(map[string]any)["telegram"].(map[string]any)
	af = tg["allowFrom"].([]any)
	if len(af) != 2 {
	...
	// Deny
	claws(t, root, "channel", "deny", "alpha", "telegram", "+1234567890")
	cfg = readJSON(t, filepath.Join(root, "alpha", "openclaw.json"))
	tg = cfg["channels"].(map[string]any)["telegram"].(map[string]any)
	af = tg["allowFrom"].([]any)
	if len(af) != 1 {
	...
	// Deny non-existent
	_, err = claws(t, root, "channel", "deny", "alpha", "telegram", "+0000000000")
	if err == nil {
...
func TestIntegration_ChannelAddOutputMentionsSend(t *testing.T) {
	...
	out, _ := claws(t, root, "channel", "add", "alpha", "telegram", "--token=123:fake")
...
func TestIntegration_ChannelSendNonExistent(t *testing.T) {
	...
	_, err := claws(t, root, "channel", "send", "alpha", "telegram", "--enable")
	if err == nil {
...
func TestIntegration_ChannelAllowNonExistent(t *testing.T) {
	...
	_, err := claws(t, root, "channel", "allow", "alpha", "telegram", "+1234567890")
	if err == nil {
		t.Error("should fail on non-existent channel")
	}
}
...
func TestIntegration_ChannelDenyNonExistent(t *testing.T) {
	...
	_, err := claws(t, root, "channel", "deny", "alpha", "telegram", "+1234567890")
	if err == nil {
		t.Error("should fail on non-existent channel")
	}
}
...
func TestIntegration_ChannelSendDiscord(t *testing.T) {
	...
	claws(t, root, "channel", "send", "alpha", "discord", "--enable")
	cfg := readJSON(t, filepath.Join(root, "alpha", "openclaw.json"))
...
func TestIntegration_LegacyChannelStillWorks(t *testing.T) {
	...
	_, err := claws(t, root, "channel", "alpha", "telegram")
