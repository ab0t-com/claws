...
- [project_clawctl_vision.md](project_clawctl_vision.md) — clawctl is evolving into a generic agent control plane with adapter pattern, admin policy, multi-tenant access
