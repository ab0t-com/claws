...
| 9 | [Health Probe Loopback Bind](health-probe-loopback-bind-2026-05-23/ticket.md) | P1 High | Open | — |
...
| 11 | [Per-instance Auth Verify + Reliable Reauth](auth-fleet-reauth-2026-05-23/ticket.md) | **P0 Critical** | Open | OpenClaw runtime cooperation |
| 12 | [Test-harness Orphan Containers](test-harness-orphan-containers-2026-05-23/ticket.md) | P1 High | Open | — |
| 13 | [Logs Interleaved Follow](logs-interleaved-follow-2026-05-23/ticket.md) | P2 Medium | Open | — |
| 14 | [Errors Umbrella Command](errors-umbrella-2026-05-23/ticket.md) | P2 Medium | Open | — |
| 15 | [Drift Reverse + Umbrella](drift-reverse-and-umbrella-2026-05-23/ticket.md) | P3 Low | Open | — |
